...
export class Operations {
  ...
  acknowledgeQuality<T = unknown>(
    id: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/quality/signals/${encodeURIComponent(id)}/acknowledge`, {
      ...options,
      body,
    });
  }
  ...
  activateFlowVoice<T = unknown>(
    flowId: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/voice/ivr/${encodeURIComponent(flowId)}/activate`, {
      ...options,
      body,
    });
  }
  ...
  addCasesEvaluation<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/evaluation/datasets/${encodeURIComponent(datasetId)}/cases`,
      { ...options, body },
    );
  }
  ...
  addCommentTickets<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/tickets/${encodeURIComponent(id)}/comments`, {
      ...options,
      body,
    });
  }
  ...
  addContactMethodCustomers<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/customers/${encodeURIComponent(id)}/contact-methods`, {
      ...options,
      body,
    });
  }
  ...
  /** Add a holiday */
  addHolidayDirectory<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/business-hours/${encodeURIComponent(id)}/holidays`, {
      ...options,
      body,
    });
  }
  ...
  addNoteCustomers<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/customers/${encodeURIComponent(id)}/notes`, {
      ...options,
      body,
    });
  }
  ...
  adherenceWfm<T = unknown>(
    ...
    return this.http.request<T>('GET', `/wfm/adherence`, {
      ...options,
  ...
  agentsAnalytics<T = unknown>(
    query?: { from?: string | number | boolean; to?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/analytics/agents`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  aiAnalytics<T = unknown>(
    query?: { from?: string | number | boolean; to?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/analytics/ai`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  applyTemplateWfm<T = unknown>(
    templateId: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/wfm/templates/${encodeURIComponent(templateId)}/apply`, {
      ...options,
      body,
    });
  }
  ...
  approveWfm<T = unknown>(requestId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/wfm/time-off/${encodeURIComponent(requestId)}/approve`, {
      ...options,
      body,
    });
  }
  ...
  assignConversations<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/conversations/${encodeURIComponent(id)}/assign`, {
      ...options,
      body,
    });
  }
  ...
  attainmentSla<T = unknown>(
    ...
    return this.http.request<T>('GET', `/sla/attainment`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  beginSso<T = unknown>(connectionId: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>(
      'POST',
      `/sso/connections/${encodeURIComponent(connectionId)}/authorize`,
      { ...options, body },
    );
  }
  ...
  calibrationQuality<T = unknown>(templateId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/quality/calibration/${encodeURIComponent(templateId)}`, {
      ...options,
    });
  }
  ...
  cancelAgents<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/agents/executions/${encodeURIComponent(id)}/cancel`, {
      ...options,
      body,
    });
  }
  ...
  cancelShiftWfm<T = unknown>(shiftId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/wfm/shifts/${encodeURIComponent(shiftId)}`, {
      ...options,
    });
  }
  ...
  /** Channel performance */
  channelsAnalytics<T = unknown>(
    query?: { from?: string | number | boolean; to?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/analytics/channels`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  clocksSla<T = unknown>(
    ...
    return this.http.request<T>(
      'GET',
      `/sla/clocks/${encodeURIComponent(subjectType)}/${encodeURIComponent(subjectId)}`,
      { ...options },
    );
  }
  ...
  commentsTickets<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/tickets/${encodeURIComponent(id)}/comments`, {
      ...options,
    });
  }

  /** Diff two runs, listing regressions first */
  compareEvaluation<T = unknown>(
    runId: string,
    ...
    return this.http.request<T>(
      'GET',
      `/evaluation/runs/${encodeURIComponent(runId)}/compare/${encodeURIComponent(candidateRunId)}`,
      { ...options },
    );
  }
  ...
  conversationIntelligenceAnalytics<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>(
      'GET',
      `/analytics/conversations/${encodeURIComponent(id)}/intelligence`,
      { ...options },
    );
  }
  ...
  countSegmentCustomers<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/customers/segments/${encodeURIComponent(id)}/count`, {
      ...options,
    });
  }
  ...
  coverageWfm<T = unknown>(forecastId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>(
      'GET',
      `/wfm/forecasts/${encodeURIComponent(forecastId)}/coverage`,
      { ...options },
    );
  }
  ...
  /** Create a category */
  createCategoryKnowledge<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/knowledge/bases/${encodeURIComponent(id)}/categories`, {
      ...options,
      body,
    });
  }
  ...
  csatConversations<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/conversations/${encodeURIComponent(id)}/csat`, {
      ...options,
      body,
    });
  }
  ...
  customerContextCopilot<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/copilot/customers/${encodeURIComponent(id)}/context`, {
      ...options,
    });
  }
  ...
  debugAgents<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/agents/executions/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  declineWfm<T = unknown>(requestId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/wfm/time-off/${encodeURIComponent(requestId)}/decline`, {
      ...options,
      body,
    });
  }
  ...
  deleteAccountChannels<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/channels/accounts/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteArticleKnowledge<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/knowledge/articles/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteAutomation<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/automation/rules/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteBaseKnowledge<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/knowledge/bases/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteBusinessHoursDirectory<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/business-hours/${encodeURIComponent(id)}`, {
      ...options,
    });
  }

  /** Remove a case from a dataset */
  deleteCaseEvaluation<T = unknown>(
    datasetId: string,
    caseId: string,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>(
      'DELETE',
      `/evaluation/datasets/${encodeURIComponent(datasetId)}/cases/${encodeURIComponent(caseId)}`,
      { ...options },
    );
  }
  ...
  deleteCategoryKnowledge<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/knowledge/categories/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteCustomFieldDirectory<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/custom-fields/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteDatasetEvaluation<T = unknown>(datasetId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/evaluation/datasets/${encodeURIComponent(datasetId)}`, {
      ...options,
    });
  }
  ...
  deleteDocumentKnowledge<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/knowledge/documents/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteFlowVoice<T = unknown>(flowId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/voice/ivr/${encodeURIComponent(flowId)}`, {
      ...options,
    });
  }
  ...
  deleteForecastWfm<T = unknown>(forecastId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/wfm/forecasts/${encodeURIComponent(forecastId)}`, {
      ...options,
    });
  }
  ...
  deleteGuardrails<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/guardrails/policies/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteIntegrations<T = unknown>(integrationId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/integrations/${encodeURIComponent(integrationId)}`, {
      ...options,
    });
  }

  /** Delete a customer note */
  deleteNoteCustomers<T = unknown>(
    id: string,
    noteId: string,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>(
      'DELETE',
      `/customers/${encodeURIComponent(id)}/notes/${encodeURIComponent(noteId)}`,
      { ...options },
    );
  }
  ...
  deleteNumberVoice<T = unknown>(numberId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/voice/numbers/${encodeURIComponent(numberId)}`, {
      ...options,
    });
  }
  ...
  deletePolicySla<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/sla/policies/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteReports<T = unknown>(reportId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/reports/${encodeURIComponent(reportId)}`, {
      ...options,
    });
  }
  ...
  deleteRuleNotifications<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/notifications/rules/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteRuleRouting<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/routing/rules/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteSavedReplyDirectory<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/saved-replies/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteSegmentCustomers<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/customers/segments/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteSourceKnowledge<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/knowledge/sources/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteSso<T = unknown>(connectionId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/sso/connections/${encodeURIComponent(connectionId)}`, {
      ...options,
    });
  }
  ...
  deleteTemplateQuality<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/quality/templates/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteTemplateTickets<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/tickets/templates/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  deleteTemplateWfm<T = unknown>(templateId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/wfm/templates/${encodeURIComponent(templateId)}`, {
      ...options,
    });
  }
  ...
  deleteUserScim<T = unknown>(userId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/scim/v2/Users/${encodeURIComponent(userId)}`, {
      ...options,
    });
  }
  ...
  deliveriesWebhooks<T = unknown>(
    query?: {
      endpointId?: string | number | boolean;
      status?: string | number | boolean;
      limit?: string | number | boolean;
    },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/webhooks/deliveries`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  deliveryWebhooks<T = unknown>(deliveryId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/webhooks/deliveries/${encodeURIComponent(deliveryId)}`, {
      ...options,
    });
  }

  /** Stop syncing without discarding the configuration */
  disableIntegrations<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/integrations/${encodeURIComponent(integrationId)}/disable`,
      { ...options, body },
    );
  }
  ...
  disableSso<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/sso/connections/${encodeURIComponent(connectionId)}/disable`,
      { ...options, body },
    );
  }

  /** Whether an email domain is routed to SSO */
  discoverSso<T = unknown>(
    query: { email: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/sso/discover`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  disputeQuality<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/quality/evaluations/${encodeURIComponent(id)}/dispute`, {
      ...options,
      body,
    });
  }
  ...
  drainRouting<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/routing/queues/${encodeURIComponent(id)}/drain`, {
      ...options,
      body,
    });
  }
  ...
  enableIntegrations<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/integrations/${encodeURIComponent(integrationId)}/enable`,
      { ...options, body },
    );
  }
  ...
  enableSso<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/sso/connections/${encodeURIComponent(connectionId)}/enable`,
      { ...options, body },
    );
  }
  ...
  evaluateQuality<T = unknown>(
    conversationId: string,
    body?: unknown,
    query?: { templateId?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/quality/evaluate/${encodeURIComponent(conversationId)}`, {
      ...options,
      body,
      query: { ...query, ...options?.query },
    });
  ...
  executionsAgents<T = unknown>(
    query?: {
      status?: string | number | boolean;
      agentId?: string | number | boolean;
      conversationId?: string | number | boolean;
    },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/agents/executions`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  executiveAnalytics<T = unknown>(
    query?: { from?: string | number | boolean; to?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/analytics/executive`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  exportCsvReports<T = unknown>(reportId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/reports/${encodeURIComponent(reportId)}/export.csv`, {
      ...options,
    });
  }
  ...
  forConversationMemory<T = unknown>(
    id: string,
    query?: { limit?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/memory/conversations/${encodeURIComponent(id)}`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  forCustomerMemory<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/memory/customers/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  forgetCustomerMemory<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/memory/customers/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  fromConversationTickets<T = unknown>(
    conversationId: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>(
      'POST',
      `/tickets/from-conversation/${encodeURIComponent(conversationId)}`,
      { ...options, body },
    );
  }

  /** Create a ticket from a template */
  fromTemplateTickets<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>(
      'POST',
      `/tickets/templates/${encodeURIComponent(id)}/instantiate`,
      { ...options, body },
    );
  }
  ...
  getArticleKnowledge<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/knowledge/articles/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  getBaseKnowledge<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/knowledge/bases/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  getDatasetEvaluation<T = unknown>(datasetId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/evaluation/datasets/${encodeURIComponent(datasetId)}`, {
      ...options,
    });
  }
  ...
  getDr<T = unknown>(backupId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/dr/backups/${encodeURIComponent(backupId)}`, {
      ...options,
    });
  }
  ...
  getEvaluationQuality<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/quality/evaluations/${encodeURIComponent(id)}`, {
      ...options,
    });
  }
  ...
  getForecastWfm<T = unknown>(forecastId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/wfm/forecasts/${encodeURIComponent(forecastId)}`, {
      ...options,
    });
  }
  ...
  getHybrid<T = unknown>(planeId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/hybrid/data-planes/${encodeURIComponent(planeId)}`, {
      ...options,
    });
  }
  ...
  getIntegrations<T = unknown>(integrationId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/integrations/${encodeURIComponent(integrationId)}`, {
      ...options,
    });
  }
  ...
  getRunEvaluation<T = unknown>(runId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/evaluation/runs/${encodeURIComponent(runId)}`, {
      ...options,
    });
  }
  ...
  getSso<T = unknown>(connectionId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/sso/connections/${encodeURIComponent(connectionId)}`, {
      ...options,
    });
  }
  ...
  getUserScim<T = unknown>(userId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/scim/v2/Users/${encodeURIComponent(userId)}`, {
      ...options,
    });
  }
  ...
  getVoice<T = unknown>(callId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/voice/calls/${encodeURIComponent(callId)}`, {
      ...options,
    });
  }
  ...
  getWebhooks<T = unknown>(endpointId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/webhooks/${encodeURIComponent(endpointId)}`, {
      ...options,
    });
  }
  ...
  hangupVoice<T = unknown>(callId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/voice/calls/${encodeURIComponent(callId)}/hangup`, {
      ...options,
      body,
    });
  }
  ...
  historyBilling<T = unknown>(
    query?: { months?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/billing/usage/history`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  historyConversations<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/conversations/${encodeURIComponent(id)}/history`, {
      ...options,
    });
  }
  ...
  historyTickets<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/tickets/${encodeURIComponent(id)}/history`, {
      ...options,
    });
  }
  ...
  holdVoice<T = unknown>(callId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/voice/calls/${encodeURIComponent(callId)}/hold`, {
      ...options,
      body,
    });
  }
  ...
  inboxConversations<T = unknown>(
    query?: {
      limit?: string | number | boolean;
      cursor?: string | number | boolean;
      status?: string | number | boolean;
      channel?: string | number | boolean;
      priority?: string | number | boolean;
      queueId?: string | number | boolean;
      assigneeId?: string | number | boolean;
    ...
    return this.http.request<T>('GET', `/conversations/inbox`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  inboxNotifications<T = unknown>(
    query?: {
      limit?: string | number | boolean;
      cursor?: string | number | boolean;
      unreadOnly?: string | number | boolean;
    },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/notifications`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  intelligenceTrendsAnalytics<T = unknown>(
    query?: { from?: string | number | boolean; to?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/analytics/intelligence`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  invokeTools<T = unknown>(key: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/tools/${encodeURIComponent(key)}/invoke`, {
      ...options,
      body,
    });
  }
  ...
  listConversations<T = unknown>(
    ...
    return this.http.request<T>('GET', `/conversations`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listCustomFieldsDirectory<T = unknown>(
    query?: { entity?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/custom-fields`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listDatasetsEvaluation<T = unknown>(
    query?: { agentId?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/evaluation/datasets`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  /** List evaluations */
  listEvaluationsQuality<T = unknown>(
    query?: { subjectId?: string | number | boolean; templateId?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/quality/evaluations`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listGroupsScim<T = unknown>(
    query?: { startIndex?: string | number | boolean; count?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/scim/v2/Groups`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listNotesCustomers<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/customers/${encodeURIComponent(id)}/notes`, {
      ...options,
    });
  }
  ...
  listRunsEvaluation<T = unknown>(
    query?: {
      datasetId?: string | number | boolean;
      agentId?: string | number | boolean;
      limit?: string | number | boolean;
    },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/evaluation/runs`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  /** List saved replies */
  listSavedRepliesDirectory<T = unknown>(
    query?: { locale?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/saved-replies`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listShiftsWfm<T = unknown>(
    ...
    return this.http.request<T>('GET', `/wfm/shifts`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listSourcesKnowledge<T = unknown>(
    query?: { knowledgeBaseId?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/knowledge/sources`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listTickets<T = unknown>(
    ...
    return this.http.request<T>('GET', `/tickets`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listTimeOffWfm<T = unknown>(
    ...
    return this.http.request<T>('GET', `/wfm/time-off`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listUsersIam<T = unknown>(
    query?: {
      limit?: string | number | boolean;
      cursor?: string | number | boolean;
      search?: string | number | boolean;
      roleKey?: string | number | boolean;
      status?: string | number | boolean;
    },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/users`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  listUsersScim<T = unknown>(
    query?: {
      filter?: string | number | boolean;
      startIndex?: string | number | boolean;
      count?: string | number | boolean;
    },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/scim/v2/Users`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  /** List calls */
  listVoice<T = unknown>(
    query?: { status?: string | number | boolean; queueId?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/voice/calls`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  markReadNotifications<T = unknown>(
    id: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/notifications/${encodeURIComponent(id)}/read`, {
      ...options,
      body,
    });
  }
  ...
  mergeCustomers<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/customers/${encodeURIComponent(id)}/merge`, {
      ...options,
      body,
    });
  }
  ...
  /** List messages */
  messagesConversations<T = unknown>(
    id: string,
    query?: { limit?: string | number | boolean; cursor?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/conversations/${encodeURIComponent(id)}/messages`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  messagesWidget<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/widget/conversations/${encodeURIComponent(id)}/messages`, {
      ...options,
    });
  }
  ...
  monitorQuality<T = unknown>(
    conversationId: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/quality/monitor/${encodeURIComponent(conversationId)}`, {
      ...options,
      body,
    });
  }
  ...
  noteConversations<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/conversations/${encodeURIComponent(id)}/notes`, {
      ...options,
      body,
    });
  }
  ...
  overviewCustomers<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/customers/${encodeURIComponent(id)}/overview`, {
      ...options,
    });
  }
  ...
  patchUserScim<T = unknown>(userId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('PATCH', `/scim/v2/Users/${encodeURIComponent(userId)}`, {
      ...options,
      body,
    });
  }
  ...
  pingWebhooks<T = unknown>(
    endpointId: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/webhooks/${encodeURIComponent(endpointId)}/ping`, {
      ...options,
      body,
    });
  }
  ...
  publishAgents<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/agents/${encodeURIComponent(id)}/publish`, {
      ...options,
      body,
    });
  }
  ...
  publishArticleKnowledge<T = unknown>(
    id: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/knowledge/articles/${encodeURIComponent(id)}/publish`, {
      ...options,
      body,
    });
  }
  ...
  publishWorkflows<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/workflows/${encodeURIComponent(id)}/publish`, {
      ...options,
      body,
    });
  }
  ...
  recordingVoice<T = unknown>(
    ...
    return this.http.request<T>(
      'GET',
      `/voice/calls/${encodeURIComponent(callId)}/recordings/${encodeURIComponent(recordingId)}`,
      { ...options },
    );
  }
  ...
  refreshContextCopilot<T = unknown>(
    id: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>(
      'POST',
      `/copilot/customers/${encodeURIComponent(id)}/context/refresh`,
      { ...options, body },
    );
  }
  ...
  reindexKnowledge<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/knowledge/documents/${encodeURIComponent(id)}/reindex`, {
      ...options,
      body,
    });
  }
  ...
  removeContactMethodCustomers<T = unknown>(
    id: string,
    methodId: string,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>(
      'DELETE',
      `/customers/${encodeURIComponent(id)}/contact-methods/${encodeURIComponent(methodId)}`,
      { ...options },
    );
  }
  ...
  removeWebhooks<T = unknown>(endpointId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('DELETE', `/webhooks/${encodeURIComponent(endpointId)}`, {
      ...options,
    });
  }

  /** Replace a user */
  replaceUserScim<T = unknown>(
    userId: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PUT', `/scim/v2/Users/${encodeURIComponent(userId)}`, {
      ...options,
      body,
    });
  }
  ...
  replyConversations<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/conversations/${encodeURIComponent(id)}/messages`, {
      ...options,
      body,
    });
  }
  ...
  resolveDisputeQuality<T = unknown>(
    id: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/quality/disputes/${encodeURIComponent(id)}/resolve`, {
      ...options,
      body,
    });
  }
  ...
  resumeAgents<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/agents/executions/${encodeURIComponent(id)}/resume`, {
      ...options,
      body,
    });
  }
  ...
  resumeBilling<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/billing/tenants/${encodeURIComponent(organizationId)}/resume`,
      { ...options, body },
    );
  }
  ...
  resumeHybrid<T = unknown>(planeId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>(
      'POST',
      `/hybrid/data-planes/${encodeURIComponent(planeId)}/resume`,
      { ...options, body },
    );
  }
  ...
  resumeVoice<T = unknown>(callId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/voice/calls/${encodeURIComponent(callId)}/resume`, {
      ...options,
      body,
    });
  }
  ...
  retrievalStatsKnowledge<T = unknown>(
    query: { from: string | number | boolean; to: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/knowledge/retrieval-stats`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  rollbackAgents<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/agents/${encodeURIComponent(id)}/rollback`, {
      ...options,
      body,
    });
  }
  ...
  rotateScimTokenSso<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/sso/connections/${encodeURIComponent(connectionId)}/scim-token`,
      { ...options, body },
    );
  }

  /** Issue a new signing secret; it is returned once */
  rotateWebhooks<T = unknown>(
    endpointId: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>(
      'POST',
      `/webhooks/${encodeURIComponent(endpointId)}/rotate-secret`,
      { ...options, body },
    );
  }
  ...
  routeRouting<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/routing/conversations/${encodeURIComponent(id)}/route`, {
      ...options,
      body,
    });
  }
  ...
  runAgents<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/agents/${encodeURIComponent(id)}/run`, {
      ...options,
      body,
    });
  }
  ...
  runEvaluation<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/evaluation/datasets/${encodeURIComponent(datasetId)}/runs`,
      { ...options, body },
    );
  }
  ...
  runReports<T = unknown>(reportId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/reports/${encodeURIComponent(reportId)}/run`, {
      ...options,
      body,
    });
  }
  ...
  runsAutomation<T = unknown>(
    query?: { ruleId?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/automation/runs`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  saveGraphWorkflows<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('PUT', `/workflows/${encodeURIComponent(id)}/graph`, {
      ...options,
      body,
    });
  }
  ...
  sayVoice<T = unknown>(callId: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/voice/calls/${encodeURIComponent(callId)}/say`, {
      ...options,
      body,
    });
  }
  ...
  scoreWfm<T = unknown>(forecastId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/wfm/forecasts/${encodeURIComponent(forecastId)}/score`, {
      ...options,
      body,
    });
  }
  ...
  searchAudit<T = unknown>(
    query?: {
      actorId?: string | number | boolean;
    ...
    return this.http.request<T>('GET', `/audit`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  searchCustomers<T = unknown>(
    ...
    return this.http.request<T>('GET', `/customers`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  searchKnowledge<T = unknown>(
    query: {
      q: string | number | boolean;
      knowledgeBaseIds?: string | number | boolean;
      locale?: string | number | boolean;
      topK?: string | number | boolean;
      rerank?: string | number | boolean;
    },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/knowledge/search`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  seriesAnalytics<T = unknown>(
    metric: string,
    query?: { from?: string | number | boolean; to?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/analytics/series/${encodeURIComponent(metric)}`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  seriesBilling<T = unknown>(
    query: {
      metric: string | number | boolean;
      from: string | number | boolean;
      to: string | number | boolean;
      dimensionValue?: string | number | boolean;
    },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/billing/metrics/series`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  setConsentMemory<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/memory/customers/${encodeURIComponent(id)}/consent`, {
      ...options,
      body,
    });
  }
  ...
  setStatusConversations<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/conversations/${encodeURIComponent(id)}/status`, {
      ...options,
      body,
    });
  }
  ...
  signalsQuality<T = unknown>(conversationId: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/quality/signals/${encodeURIComponent(conversationId)}`, {
      ...options,
    });
  }
  ...
  simulateRouting<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>(
      'GET',
      `/routing/conversations/${encodeURIComponent(id)}/simulate`,
      { ...options },
    );
  }
  ...
  simulateVoice<T = unknown>(flowId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/voice/ivr/${encodeURIComponent(flowId)}/simulate`, {
      ...options,
      body,
    });
  }
  ...
  suspendBilling<T = unknown>(
    ...
    return this.http.request<T>(
      'POST',
      `/billing/tenants/${encodeURIComponent(organizationId)}/suspend`,
      { ...options, body },
    );
  }

  /** Stop accepting heartbeats from a plane */
  suspendHybrid<T = unknown>(
    planeId: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>(
      'POST',
      `/hybrid/data-planes/${encodeURIComponent(planeId)}/suspend`,
      { ...options, body },
    );
  }
  ...
  syncIntegrations<T = unknown>(
    integrationId: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/integrations/${encodeURIComponent(integrationId)}/sync`, {
      ...options,
      body,
    });
  }
  ...
  syncSourceKnowledge<T = unknown>(
    id: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/knowledge/sources/${encodeURIComponent(id)}/sync`, {
      ...options,
      body,
    });
  }
  ...
  testIntegrations<T = unknown>(
    integrationId: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/integrations/${encodeURIComponent(integrationId)}/test`, {
      ...options,
      body,
    });
  }
  ...
  timelineCustomers<T = unknown>(
    id: string,
    query?: { limit?: string | number | boolean; cursor?: string | number | boolean },
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('GET', `/customers/${encodeURIComponent(id)}/timeline`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  transferConversations<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/conversations/${encodeURIComponent(id)}/transfer`, {
      ...options,
      body,
    });
  }
  ...
  transferVoice<T = unknown>(callId: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/voice/calls/${encodeURIComponent(callId)}/transfer`, {
      ...options,
      body,
    });
  }
  ...
  turnVoice<T = unknown>(callId: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/voice/calls/${encodeURIComponent(callId)}/turn`, {
      ...options,
      body,
    });
  }
  ...
  unpublishArticleKnowledge<T = unknown>(
    id: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/knowledge/articles/${encodeURIComponent(id)}/unpublish`, {
      ...options,
      body,
    });
  }
  ...
  updateAccountChannels<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/channels/accounts/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateArticleKnowledge<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/knowledge/articles/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateAutomation<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('PATCH', `/automation/rules/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateBaseKnowledge<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/knowledge/bases/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateBusinessHoursDirectory<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/business-hours/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateConfigHybrid<T = unknown>(
    ...
    return this.http.request<T>(
      'PATCH',
      `/hybrid/data-planes/${encodeURIComponent(planeId)}/config`,
      { ...options, body },
    );
  }

  /** Update subject, priority, tags or locale */
  updateConversations<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/conversations/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateCustomers<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('PATCH', `/customers/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  /** Update a dataset */
  updateDatasetEvaluation<T = unknown>(
    datasetId: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/evaluation/datasets/${encodeURIComponent(datasetId)}`, {
      ...options,
      body,
    });
  }
  ...
  /** Update an IVR flow */
  updateFlowVoice<T = unknown>(
    flowId: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/voice/ivr/${encodeURIComponent(flowId)}`, {
      ...options,
      body,
    });
  }
  ...
  updateGuardrails<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('PATCH', `/guardrails/policies/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateIntegrations<T = unknown>(
    integrationId: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/integrations/${encodeURIComponent(integrationId)}`, {
      ...options,
      body,
    });
  }
  ...
  updateNumberVoice<T = unknown>(
    numberId: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/voice/numbers/${encodeURIComponent(numberId)}`, {
      ...options,
      body,
    });
  }
  ...
  updatePolicySla<T = unknown>(id: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('PATCH', `/sla/policies/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  /** Update a queue */
  updateQueueDirectory<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
  ...
  updateReports<T = unknown>(
    reportId: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/reports/${encodeURIComponent(reportId)}`, {
      ...options,
      body,
    });
  }
  ...
  updateRuleNotifications<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/notifications/rules/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateRuleRouting<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('PATCH', `/routing/rules/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateSavedReplyDirectory<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/saved-replies/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateSso<T = unknown>(
    ...
    return this.http.request<T>('PATCH', `/sso/connections/${encodeURIComponent(connectionId)}`, {
      ...options,
      body,
    });
  }
  ...
  updateTemplateQuality<T = unknown>(
    id: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/quality/templates/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateTickets<T = unknown>(id: string, body: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('PATCH', `/tickets/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  updateWebhooks<T = unknown>(
    endpointId: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/webhooks/${encodeURIComponent(endpointId)}`, {
      ...options,
      body,
    });
  }
  ...
  /** Update a workspace */
  updateWorkspaceTenancy<T = unknown>(
    id: string,
    body: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('PATCH', `/workspaces/${encodeURIComponent(id)}`, {
      ...options,
      body,
    });
  }
  ...
  usageAi<T = unknown>(
    ...
    return this.http.request<T>('GET', `/ai/usage`, {
      ...options,
      query: { ...query, ...options?.query },
    });
  }
  ...
  validateWorkflows<T = unknown>(id: string, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('GET', `/workflows/${encodeURIComponent(id)}/validate`, {
      ...options,
    });
  }
  ...
  verifyDr<T = unknown>(backupId: string, body?: unknown, options?: RequestOptions): Promise<T> {
    return this.http.request<T>('POST', `/dr/backups/${encodeURIComponent(backupId)}/verify`, {
      ...options,
      body,
    });
  }
  ...
  webhookVoice<T = unknown>(
    provider: string,
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> {
    return this.http.request<T>('POST', `/voice/webhooks/${encodeURIComponent(provider)}`, {
      ...options,
      body,
    });
  }
